// components/MatchingCard.jsx
import React, { useState, useEffect, useRef } from 'react';

function MatchingCard({ data, card1_col, card2_col, hiraCol, speakText, onClose, selectedTime }) {
  ...
  // 2. Thuật toán lấy 6 phần tử ngẫu nhiên phân bố đều từ baseList
  const getNext6Pairs = () => {
